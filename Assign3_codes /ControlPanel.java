...
public class ControlPanel extends Frame implements ActionListener {
	...
	public void init(Process replaceOpt) {
		process = replaceOpt;
		//process = new Process(myreplaceOpt);
		//replaceOpt = myreplaceOpt;
		setLayout(null);
		...
		runButtonDelay.addActionListener(this);
		...
		for (i = 0; i < process.kernel.page.numVirtualPages; i++) {
			...
			buttons[i].setBounds(column, (row + 2) * 15 + 25, 70, 15);
		...
		runButtonDelay.setBounds(500, 25, 70, 15);
		//add(runButtonDelay);
		...
		compoundInstructValueLabel.setBounds(500, 45 + 25, 100, 15);
		...
		PValueLabel.setBounds(395, 150 + 25, 200, 15);
		add(PValueLabel);
		
		RValueLabel.setBounds(395, 165 + 25, 200, 15);
		add(RValueLabel);
		
		MValueLabel.setBounds(395, 180 + 25, 200, 15);
		add(MValueLabel);
		
		UValueLabel.setBounds(395, 195 + 25, 200, 15);
		add(UValueLabel);
		
		inMemTimeValueLabel.setBounds(395, 210 + 25, 200, 15);
		add(inMemTimeValueLabel);
		
		lastTouchTimeValueLabel.setBounds(395, 225 + 25, 200, 15);
		add(lastTouchTimeValueLabel);
		
		lowValueLabel.setBounds(395, 240 + 25, 230, 15);
		add(lowValueLabel);
		
		highValueLabel.setBounds(395, 255 + 25, 230, 15);
		add(highValueLabel);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == runButton) {
			...
			runButtonDelay.setEnabled(false);
			process.run();
			setStatus("STOP");
			resetButton.setEnabled(true);
			
		}
		if (e.getSource() == runButtonDelay) {
			setStatus("RUN");
			runButton.setEnabled(false);
			stepButton.setEnabled(false);
			resetButton.setEnabled(false);
		...
		if (e.getSource() == resetButton) {
			...
			runButtonDelay.setEnabled(true);
